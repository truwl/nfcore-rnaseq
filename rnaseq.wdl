...
workflow rnaseq {
	input{
		...
		String ribo_database_manifest = "/rnaseq-3.6/assets/rrna-db-defaults.txt"
		...
		String rseqc_modules = "bam_stat,inner_distance,infer_experiment,junction_annotation,junction_saturation,read_distribution,read_duplication"
		Boolean? deseq2_vst
		Boolean? skip_bigwig
...
task run_nfcoretask {
    ...
    runtime {
        docker: "truwl/nfcore-rnaseq:3.6_0.1.0"
        memory: "2 GB"
        cpu: 1
    }
}
